			...
			<div class="header">
				<div class="wrap">
					<div class="header-top">
						...
						<p style="font: size 100px;"><a href="logout.php">Logout</a></p>
				...
				<div class="header-top-nav">
					<div class="wrap">
						<ul>
							<li class="active">
							<li><a href="menumanage.html">Menu management</a></li>
							<li><a href="inv_main.php">inventory management</a></li>
							<li><a href="paymain.php">Payroll Management</a></li>
