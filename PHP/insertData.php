...
$sql="INSERT INTO inventory (`slno`, `item name`, `item price`) VALUES ($slno, '$name', $price)";
...
<input type="text" placeholder="slno" name="serial"><br>
<input type="text" placeholder="name" name="itemname"><br>
